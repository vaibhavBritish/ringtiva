  ...
  return (
    <div>
      <section className="relative w-full min-h-[90vh] flex items-center bg-linear-to-r from-[#6A4DFF] to-[#8E68FF] overflow-hidden rounded-b-3xl">
        <Image
          src="https://ringtivassests.blob.core.windows.net/ringtiva-images/industries/solar/bg-health.jpg"
      ...
      <section className='max-w-6xl mx-auto px-5 py-10'>
        <div className=' grid md:grid-cols-2 gap-10'>
          ...
          <div>
            <Image
              src={"https://ringtivassests.blob.core.windows.net/ringtiva-images/industries/solar/solar.png"}
      ...
      <section className='max-w-6xl mx-auto px-10 py-28'>
        <div className='grid md:grid-cols-2 gap-10'>
          <div>
            <Image
              src={"https://ringtivassests.blob.core.windows.net/ringtiva-images/industries/solar/solar1.png"}
              alt='homeimprovement'
              width={450}
              height={350}
            />
